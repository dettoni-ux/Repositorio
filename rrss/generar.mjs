  ...
  return [
    ...
    },
    {
      ...
      video: {
        ...
        escenas_ia: [
          { prompt_ia: 'High-quality 3D cartoon animation, soft rounded characters, big expressive eyes, warm cinematic lighting, family-friendly, vertical 9:16. In a cozy veterinary waiting room with deep purple (#5B2E7E) walls, yellow (#FFD84D) chairs and a warm tiled floor, a small round-faced cartoon beagle puppy with tan and white fur, floppy brown ears and a red collar sits patiently on a chair beside its owner, ears perked, looking up at a closed consulting room door. No text overlays, no logos, no watermarks.', duracion_s: 8 },
          { prompt_ia: 'High-quality 3D cartoon animation, soft rounded characters, big expressive eyes, warm cinematic lighting, family-friendly, vertical 9:16. In a cozy veterinary waiting room with deep purple (#5B2E7E) walls, yellow (#FFD84D) chairs and a warm tiled floor, a chubby middle-aged man with a thick black moustache, tan skin and messy dark hair, wearing a white lab coat three sizes too big and a plastic toy stethoscope proudly opens a plastic toy doctor kit; behind him a diploma drawn in crayon is taped crookedly to the purple wall and slowly peels off. A small round-faced cartoon beagle puppy with tan and white fur, floppy brown ears and a red collar tilts its head, unconvinced. No text overlays, no logos, no watermarks.', duracion_s: 8 },
          { prompt_ia: 'High-quality 3D cartoon animation, soft rounded characters, big expressive eyes, warm cinematic lighting, family-friendly, vertical 9:16. In a cozy veterinary waiting room with deep purple (#5B2E7E) walls, yellow (#FFD84D) chairs and a warm tiled floor, a warm cartoon woman veterinarian in her thirties with brown skin, dark hair in a bun, wearing a well-fitted white coat with a glowing blue verification badge on the chest opens the consulting room door and kneels down with a warm smile. A small round-faced cartoon beagle puppy with tan and white fur, floppy brown ears and a red collar trots over happily, tail wagging. No text overlays, no logos, no watermarks.', duracion_s: 8 },
        ],
        ...
        escenas: [
          { tiempo: '0-4 s', descripcion: 'El “doctor” con delantal gigante y diploma a crayón abre un maletín de juguete', texto_pantalla: '¿Tu “veterinario”… es veterinario?' },
          { tiempo: '4-7 s', descripcion: 'El diploma de crayón se despega de la pared', texto_pantalla: 'Cualquiera puede ponerse una bata' },
          { tiempo: '7-10 s', descripcion: 'Aparece la veterinaria con insignia azul brillante y recibe a la mascota', texto_pantalla: 'La insignia azul se verifica: Registro Civil + COLMEVET' }
        ]
      }
    }
